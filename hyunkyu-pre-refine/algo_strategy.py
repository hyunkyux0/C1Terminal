...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def build_defense(self, game_state):
        ...
        # === V-ARM TURRETS (progressive, top to bottom) ===
        # attempt_spawn is idempotent -- already-placed are skipped,
        # so each turn builds the next affordable pair in the list
        v_arm_turrets = [
            [6, 11], [21, 11],      # first V extension
            [7, 10], [20, 10],      # second
        ...
        # === CORNER WALLS (skip/remove if enemy blocks that edge) ===
